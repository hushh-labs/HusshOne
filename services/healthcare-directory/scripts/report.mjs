#!/usr/bin/env node
// Daily progress report: read the live counters from Postgres, render the HTML
// summary (scripts/lib/report.mjs), email it to the ops recipients via the Gmail
// SMTP mailer, and audit the send to email_reports. Run on a systemd timer.
//
// Usage:
