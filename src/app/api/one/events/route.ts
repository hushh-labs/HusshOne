...
const ALLOWED_EVENTS = new Set([
  ...
  "instagram_connected",
  "instagram_connect_pending",
  "instagram_connect_failed",
  "threads_connect_started",
  "threads_connected",
  "threads_connect_pending",
  "threads_connect_failed",
  "x_connect_started",
  "x_connected",
  "x_connect_pending",
  "x_connect_failed",
  ...
  "progressive_dashboard_opened",
  "phase1_stream_started",
  "phase1_stream_completed",
  "phase1_stream_pending",
  "geo_denied",
  "started_over",
  "account_deleted",
  "client_error",
